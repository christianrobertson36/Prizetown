...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v77' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v77 reveal machine draw screen)`)))
  .catch((err) => {
