...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v78' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v78 trusted wheel draw)`)))
  .catch((err) => {
