...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v51' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v51 homepage footer polish)`)))
  .catch((err) => {
