...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v47' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v47 Arnold homepage build fix)`)))
  .catch((err) => {
