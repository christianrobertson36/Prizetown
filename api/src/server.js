...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v83' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v83 wheel label orientation)`)))
  .catch((err) => {
