...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v42' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v42 draw array dropdown fix)`)))
  .catch((err) => {
