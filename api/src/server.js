...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v85' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v85 wheel of luck demo)`)))
  .catch((err) => {
