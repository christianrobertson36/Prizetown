...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v66' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v66 broadcast date time)`)))
  .catch((err) => {
