...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v48' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v48 Arnold clean build fix)`)))
  .catch((err) => {
