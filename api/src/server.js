...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v74' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v74 synced numbered wheel)`)))
  .catch((err) => {
