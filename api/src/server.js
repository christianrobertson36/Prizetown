...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v52' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v52 front page high life showcase)`)))
  .catch((err) => {
