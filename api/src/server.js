...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v45' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v45 longer spin sound)`)))
  .catch((err) => {
