...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v75' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v75 visual draw no wheel numbers)`)))
  .catch((err) => {
