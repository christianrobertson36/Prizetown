...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v54' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v54 hero tile click fix)`)))
  .catch((err) => {
