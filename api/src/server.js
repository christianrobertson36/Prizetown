...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v44' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v44 final draw section only)`)))
  .catch((err) => {
