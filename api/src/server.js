...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v67' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v67 OBS test button)`)))
  .catch((err) => {
