...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v53' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v53 fill hero gap)`)))
  .catch((err) => {
