...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v46' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v46 Arnold host mode)`)))
  .catch((err) => {
