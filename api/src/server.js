...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v82' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v82 logo controls fix)`)))
  .catch((err) => {
