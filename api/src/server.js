...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v55' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v55 inline scroll fix)`)))
  .catch((err) => {
