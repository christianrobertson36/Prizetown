...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v84' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v84 wheel labels near edge)`)))
  .catch((err) => {
