...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v43' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v43 bigger colourful spinner)`)))
  .catch((err) => {
