...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v68' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v68 OBS layout polish)`)))
  .catch((err) => {
