...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v76' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v76 stop point ticket badge)`)))
  .catch((err) => {
