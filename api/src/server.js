...
app.get('/health', (_req, res) => res.json({ ok: true, app: 'Prizetown API', version: 'v69' }));
...
initDb()
  .then(() => app.listen(port, () => console.log(`Prizetown API running on ${port} (v69 standalone OBS broadcast)`)))
  .catch((err) => {
